                    ...
                    <Paper className={classes.paper}>
                            <Grid container spacing={2}>
                                ...
                                <Grid item className={classes.infoSection} xs={12} sm={7}>
                                    <Grid container className={classes.buttonsAndBiography} spacing={3}>
                                        <Grid item>
                                        ...
                                        <Grid item>
                                            <Button variant="contained" color="primary" size="small">Edit Info</Button>
                                        </Grid>

                                        <Grid item>
                                            <Button variant="contained" color="primary" size="small">Add A New Project</Button>
                                        </Grid>
                                    </Grid>
                                </Grid>
